...
module.exports = function (ctx) {
  ...
  var configXml = shell.ls(
    path.join(ctx.opts.projectRoot, "platforms/windows/config.xml")
  )[0];
  var pluginXml = shell.ls(
    path.join(ctx.opts.projectRoot, "plugins/cordova-plugin-ms-adal/plugin.xml")
  )[0];
  ...
  var ssoPluginInstallPath = path.join(
